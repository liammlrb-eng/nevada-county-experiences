"""
Generate demo_pitch.pptx — a focused 14-slide deck for the county presentation.
...
# ─── Slide 2: Overview / By the numbers ────────────────────────────────────
s = prs.slides.add_slide(BLANK)
...
# ─── Slide 3: Who this serves (personas) ──────────────────────────────────
s = prs.slides.add_slide(BLANK)
...
# ─── Slide 8: Behind the scenes — admin & AI ────────────────────────────
s = prs.slides.add_slide(BLANK)
...
# ─── Slide 9: AI categorization detail ──────────────────────────────────
s = prs.slides.add_slide(BLANK)
...
# Override: shift this table to right side using a different approach
# (the simpler approach — just include in-place)
