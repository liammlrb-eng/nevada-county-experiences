...
TRAILS = [
    ...
    {
        "id": "hardrock-trail",
        "ways": [316165314, 316165323, 1449566340],
    },
    {
        "id": "osborne-hill-loop",
        "ways": [47063764, 47063770, 316165318],
    },
    {
        "id": "empire-street-trail",
        "ways": [386844690, 386844691, 1449566319],
    },
    # ── Grass Valley urban + open-space ─────────────────────────────────
    {
        "id": "wolf-creek-trail",
        "ways": [781490218, 781490219, 781490220, 781490221, 781490222,
                 781490223, 1085194150, 1085194151, 1085194152, 1085194153],
    },
    {
        "id": "loma-rica-trail",
        "ways": [449267804, 449267809, 449267810, 449267811, 1484169230,
                 1484182150, 1484182151, 1489652722, 1490037853, 1490037854,
                 1505012495, 1505012497],
    },
    {
        "id": "litton-trail",
        "ways": [598202043, 776926292, 776926293, 776926294, 812556823,
                 1087658717],
    },
    {
        "id": "memorial-park-trail",
        "ways": [316329437, 387057767],
    },
    # ── Nevada City area ────────────────────────────────────────────────
    {
        "id": "spring-creek-trail",
        "ways": [230598509],
    },
    # ── Mountain biking / further east ──────────────────────────────────
    {
        "id": "round-mountain-trail",
        "ways": [248183883, 248183884, 1245149003, 1245401533],
    },
    # ── Bowman Lake area (interpretive) ─────────────────────────────────
    {
        "id": "sierra-discovery-trail",
